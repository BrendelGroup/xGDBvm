...
<div class="dialogcontainer">
	<h2 class="bottommargin1">Pipeline Error 10.03</h2>
	
	 
	<h3>Sequence ID mismatch in TSA spliced alignment table </h3>

	<ul class="bullet1 indent2">
		<li>The TSA spliced alignment table <b>gseg_put_good_pgs</b> contains identifiers for both TSA and scaffold sequence, and these identifiers must be the SAME as those used in the <b>gseg</b> and <b>put</b> (TSA) tables.
</li>
		...
		<li>For example, you may have converted scaffold identifiers in the fasta file (~gdna.fa) to <span class="plaintext">e.g. >scaff_001</span>, but in your GeneSeqer run (~tsa.gsq) you used their original GeneBank IDs (e.g. <span class="plaintext">>gi|7846234</span>).</li>
    ...
    <ol class="orderedlist1">
        <li>Check the GeneSeqer output file (~tsa.gsq) and sequence files (~gdna.fa and ~tsa.fa) to identify which IDs are mismatched.</li>
