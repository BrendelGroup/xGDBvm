...
<p><b>Integrity Score</b> is evaluated by estimating the level of annotation support which is required to provide a structure unlikely to be significantly altered by reannotation with available evidence.  (<a target="_blank" href="/src/GAEVAL/docs/integrity.html">See details here</a>)  The score in this table is an average across all gene models at this locus. </p>
