<div class="dialogcontainer">
	<h2 class="bottommargin1"> GenomeThreader license for TACC</h2>
		...
		<p>How to obtain a license key for GenomeThreader:</p>
			<ul class="bullet1 indent2">
				<li>Follow instructions on the <a title="Data Volumes" href="/XGDB/conf/licenses.php">Licenses</a> page for information on obtaining and installing GTH license key.</li>
				<li>Store the key in the location indicated above without altering its name.</li>
				<li>Make sure your key is up to date as out of date keys will not allow GTH execution </li>

			</ul>

		<span class="heading normalfont linkback"> <a class="smallerfont" href="/XGDB/help/remote_jobs.php#gth_license">View this in Help Context</a> (remote_jobs.php/gth_license)</span>
