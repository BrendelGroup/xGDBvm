...
<div class="dialogcontainer">
	<h2 class="bottommargin1">Pipeline Error 10.01</h2>
	
	 
	<h3>Sequence ID mismatch in EST spliced alignment table </h3>

	<ul class="bullet1 indent2">
		<li>The EST spliced alignment table <b>gseg_est_good_pgs</b> contains identifiers for both EST and scaffold sequence, and these identifiers must be the SAME as those used in the <b>gseg</b> and <b>est</b> tables.
</li>
		...
		<li>For example, you may have converted scaffold identifiers in the fasta file (~gdna.fa) to <span class="plaintext"> e.g. >scaff_001</span>, but in your GeneSeqer run (~est.gsq) you used their original GeneBank IDs (e.g. <span class="plaintext">>gi|7846234</span>).</li>
    ...
    <ol class="orderedlist1">
        <li>Check the GeneSeqer output file (~est.gsq) and sequence files (~gdna.fa and ~est.fa) to identify which IDs are mismatched.</li>
