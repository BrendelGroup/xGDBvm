...
<div class="dialogcontainer">
	...
	<p>Options available for GeneSeqer</p>
	<ul class="bullet1">
		...
		<li><b>External</b> - (if configured under <a href="/XGDB/jobs/configure.php#gsq">Remote Jobs</a> and user has <a href="/XGDB/jobs/configure.php#auth">Login Credentials</a>) data will be copied to an external high performance compute server, and final output data copied back the xGDBvm local drive</li>
	</ul>
...
<p>After computation, output data will be copied back to your attached data store; data will also be loaded to the xGDBvm's databases.</p>
 ...
 <p class=tip_style>&nbsp;Note: If <b>Remote</b> option is not displayed, your VM may not be correctly configured under <a href="/XGDB/jobs/configure.php">Remote Jobs</a>.</p>
			...
			<span class="heading normalfont linkback"> <a class="smallerfont" href="/XGDB/help/create_gdb.php#config_compute_res_gsq">View this in Help Context</a> (create_gdb.php/config_compute_res_gsq)</span>
</div>
