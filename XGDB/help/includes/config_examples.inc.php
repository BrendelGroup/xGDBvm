...
<h3>To run an Example:</h3>
	...
	<li>Note particularly the <b>Input Data Path</b>, which for the Examples will be <span class="plaintext largerfont">/xGDBvm/examples/</span>. When you use your own data the path will be a directory you specify under <span class="plaintext largerfont">/xGDBvm/input/</span> (i.e. your Data Store, for iPlant users) </li>
