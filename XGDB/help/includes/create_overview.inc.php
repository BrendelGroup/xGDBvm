...
<div class="dialogcontainer">				 		
    <h2 class="bottommargin1">Creating a Genome Browser with xGDBvm (Overview):</h2>
    <p>Below is a summary of the xGDBvm workflow (managed via the the <i>Manage &rarr; Configure/Create</i> menus above):</p>
    <p> <span class="warning"> &nbsp; You may need an <b>admin</b> login account to peform these steps.</span></p>
      <ul class="bullet1">
    ...
    <p class="instruction">Visit <a title="Configuration: Getting Started" href="/XGDB/conf/index.php">Getting Started</a> for complete stepwise instructions for creating your GDB.</p>
				 		
			<span class="heading normalfont linkback"> <a class="smallerfont" href="/XGDB/help/create_gdb.php#create_overview">View this in Help Context</a> (create_gdb.php/create_overview)</span>
</div>
