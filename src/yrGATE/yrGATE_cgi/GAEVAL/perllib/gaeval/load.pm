...
sub loadGFF{
  ...
  $argHR->{CUSTOM_EVIDENCE_TYPES}={%{$argHR->{CUSTOM_EVIDENCE_TYPES}},match=>1,cDNA_match=>1,EST_match=>1,nucleotide_match=>1,nucleotide_to_protein_match=>1,nucleotide_motif=>1,GeneSeqer_EST=>1,GeneSeqer_PUT=>1,GeneSeqer_cDNA=>1} if($argHR->{_opt_all_evtype});
