...
// ANNOTATION_RESID = array index in SITEDEF.pl of Annotation track ; color should be matched to track color in SITEDEF.pl and SITEDEF.php
$GAEVAL_SOURCES = array('Precomputed Annotations' => 'gseg_gene_annotation:gseg_gbk_gaeval:gseg_gbk_gaeval_properties:gseg_gbk_gaeval_flags:3:blue', 'CpGAT Annotations' => 'gseg_cpgat_gene_annotation:gseg_cpgat_gbk_gaeval:gseg_cpgat_gbk_gaeval_properties:gseg_cpgat_gbk_gaeval_flags:2:lime');
