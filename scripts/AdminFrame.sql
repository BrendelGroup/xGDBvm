...
CREATE TABLE `admin` (
  ...
  `gsq_proc_per_node` int(3) NOT NULL default '0',
  `gth_proc_per_node` int(3) NOT NULL default '0',
  PRIMARY KEY (`uid`)
...
CREATE TABLE `jobs` (
  `uid` int(6) NOT NULL auto_increment,
  `nonce` varchar(256) NOT NULL default '',
  ...
  `softwareName` varchar(32) NOT NULL default '',
  `job_URL` varchar(500) NOT NULL default '',
  `HPC_name` varchar(32) NOT NULL default '',
